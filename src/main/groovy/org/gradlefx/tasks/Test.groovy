...
class Test extends DefaultTask {
    ...
    public static final String DEFAULT_MISSING_COMMAND_MESSAGE = "The Flash player executable is not found"
    ...
    private String findFlexUnitCommand() {
        if (flexUnit.player == 'air')
            return getAdlPath()
        throwMissingCommandException(DEFAULT_MISSING_COMMAND_MESSAGE)
    }
